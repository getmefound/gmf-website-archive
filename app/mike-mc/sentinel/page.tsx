    ...
    <ControlShell wide>
      ...
      <section className="mb-8">
        <SectionHeader
          ...
          sub="Hot means Sentinel sees an opportunity or constraint worth attention now. Cool means monitor on cadence."
        />
      ...
      <section className="mb-8 grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
        ...
        <aside>
          <SectionHeader
            ...
            sub="Five links max unless Mike asks Sentinel for more."
          />
          <div className="grid gap-3">
