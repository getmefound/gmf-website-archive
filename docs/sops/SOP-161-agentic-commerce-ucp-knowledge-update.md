# SOP 161 - Agentic commerce/UCP knowledge update
...
Source of truth: `docs/sops/SOP-161-agentic-commerce-ucp-knowledge-update.md`

## Purpose

Make the `Agentic commerce/UCP knowledge update` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Agentic commerce/UCP knowledge update
...
Google UCP or related protocol changes

## Expected Output

Updated sales-safe and client-safe guidance
...
- Expected output: Updated sales-safe and client-safe guidance
