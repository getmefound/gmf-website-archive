# SOP 100 - Content and GBP post planning
...
Source of truth: `docs/sops/SOP-100-content-and-gbp-post-planning.md`

## Purpose

Make the `Content and GBP post planning` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Content and GBP post planning
...
- Do not edit a public business profile unless the exact profile, access, and approval path are confirmed.
...
- Expected output: Post/content plan
