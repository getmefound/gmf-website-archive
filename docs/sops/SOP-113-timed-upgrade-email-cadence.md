# SOP 113 - Timed upgrade email cadence
...
Source of truth: `docs/sops/SOP-113-timed-upgrade-email-cadence.md`

## Purpose

Make the `Timed upgrade email cadence` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Timed upgrade email cadence
...
Client reaches planned lifecycle window

## Expected Output

Day 14/30/45/60/75-90 send-or-hold decision
...
- Expected output: Day 14/30/45/60/75-90 send-or-hold decision
