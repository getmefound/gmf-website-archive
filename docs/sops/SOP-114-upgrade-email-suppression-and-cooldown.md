# SOP 114 - Upgrade email suppression and cooldown
...
Source of truth: `docs/sops/SOP-114-upgrade-email-suppression-and-cooldown.md`

## Purpose

Make the `Upgrade email suppression and cooldown` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Upgrade email suppression and cooldown
...
Client is blocked, unhappy, new, or recently pitched

## Expected Output

Hold/suppress decision
...
- Expected output: Hold/suppress decision
