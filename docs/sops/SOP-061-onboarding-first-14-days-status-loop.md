# SOP 061 - Onboarding first-14-days status loop
...
Source of truth: `docs/sops/SOP-061-onboarding-first-14-days-status-loop.md`

## Purpose

Make the `Onboarding first-14-days status loop` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Onboarding first-14-days status loop
...
New client in launch window

## Expected Output

Daily/weekly status and blockers
...
- Expected output: Daily/weekly status and blockers
