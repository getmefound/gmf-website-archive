# SOP 075 - Before/after visibility snapshot
...
Source of truth: `docs/sops/SOP-075-before-after-visibility-snapshot.md`

## Purpose

Make the `Before/after visibility snapshot` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Proof snapshot
