# SOP 148 - Monthly recurring revenue review
...
Source of truth: `docs/sops/SOP-148-monthly-recurring-revenue-review.md`

## Purpose

Make the `Monthly recurring revenue review` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Monthly recurring revenue review
...
- Expected output: Active clients and MRR
