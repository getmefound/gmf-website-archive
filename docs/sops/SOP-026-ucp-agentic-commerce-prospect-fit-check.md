# SOP 026 - UCP/agentic commerce prospect fit check
...
Source of truth: `docs/sops/SOP-026-ucp-agentic-commerce-prospect-fit-check.md`

## Purpose

Make the `UCP/agentic commerce prospect fit check` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- UCP/agentic commerce prospect fit check
...
Prospect sells products, bookings, food delivery, hospitality, or ecommerce

## Expected Output

Note whether agentic commerce readiness matters

## Roles

| Role | Responsibility |
|---|---|
| Owner | Scout owns the outcome and keeps this SOP current |
...
- Expected output: Note whether agentic commerce readiness matters
