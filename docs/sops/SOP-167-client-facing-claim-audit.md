...
Source of truth: `docs/sops/SOP-167-client-facing-claim-audit.md`

## Purpose

Make the `Client-facing claim audit` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Claim-safe approval
