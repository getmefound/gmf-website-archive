# SOP 137 - Universal Commerce Protocol monitoring

Status: Drafted
Version: 0.2
Owner: Scout/Systems Director
Reviewer: Coach
Approver: SOP owner
Effective date: Set when Active
Next review: Set when Active
Source of truth: `docs/sops/SOP-137-universal-commerce-protocol-monitoring.md`

## Purpose

Make the `Universal Commerce Protocol monitoring` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Universal Commerce Protocol monitoring
...
Google UCP, Merchant Center, AP2, or agentic checkout changes

## Expected Output

Plain-English update and GMF impact note

## Roles

| Role | Responsibility |
|---|---|
| Owner | Scout/Systems Director owns the outcome and keeps this SOP current |
| Operator | Performs the work and reports gaps or blockers |
| Reviewer | Coach checks proof, quality, and risk controls |
...
1. Confirm the research question, prospect/client context, source, and allowed public-data boundary.
2. Gather public facts only: business identity, website, GBP/public profile, visible services, location, reviews, competitors, and platform signals relevant to the trigger.
3. Record source URLs, date checked, uncertainty, and what should not be inferred.
4. Classify the result as fit, hold, no-fit, watch, or needs specialist review.
5. Hand off notes to the owning role without contacting the prospect/client directly unless another SOP authorizes it.

## Required Proof

- Expected output: Plain-English update and GMF impact note
