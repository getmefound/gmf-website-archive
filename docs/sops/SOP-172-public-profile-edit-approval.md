...
Source of truth: `docs/sops/SOP-172-public-profile-edit-approval.md`

## Purpose

Make the `Public profile edit approval` workflow repeatable, auditable, and safe to delegate.
...
GBP/site/public change requested

## Expected Output

Edit approved or held
...
- Expected output: Edit approved or held
