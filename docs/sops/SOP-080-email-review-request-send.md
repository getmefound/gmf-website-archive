# SOP 080 - Email review request send
...
Source of truth: `docs/sops/SOP-080-email-review-request-send.md`

## Purpose

Make the `Email review request send` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Send log and failure list
