# SOP 157 - Client-safe language review
...
Source of truth: `docs/sops/SOP-157-client-safe-language-review.md`

## Purpose

Make the `Client-safe language review` workflow repeatable, auditable, and safe to delegate.
...
Public or client-facing copy changes
...
- Expected output: Approved wording
