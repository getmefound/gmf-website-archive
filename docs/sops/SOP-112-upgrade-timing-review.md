...
Source of truth: `docs/sops/SOP-112-upgrade-timing-review.md`

## Purpose

Make the `Upgrade timing review` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Upgrade timing review
...
- Expected output: Relationship timing decision
