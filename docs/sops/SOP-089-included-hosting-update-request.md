# SOP 089 - Included hosting update request
...
Source of truth: `docs/sops/SOP-089-included-hosting-update-request.md`

## Purpose

Make the `Included hosting update request` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Included hosting update request
...
Client requests minor site update

## Expected Output

Accepted/declined/update path
...
- Expected output: Accepted/declined/update path
