# SOP 081 - Follow-up review request send
...
Source of truth: `docs/sops/SOP-081-follow-up-review-request-send.md`

## Purpose

Make the `Follow-up review request send` workflow repeatable, auditable, and safe to delegate.
...
Suppression-safe follow-up log
...
- Expected output: Suppression-safe follow-up log
