# SOP 101 - FAQ/schema/location-page recommendation
...
Source of truth: `docs/sops/SOP-101-faq-schema-location-page-recommendation.md`

## Purpose

Make the `FAQ/schema/location-page recommendation` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- FAQ/schema/location-page recommendation
...
- Expected output: Recommendation and handoff
