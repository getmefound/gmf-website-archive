...
Source of truth: `docs/sops/SOP-169-sop-adherence-audit.md`

## Purpose

Make the `SOP adherence audit` workflow repeatable, auditable, and safe to delegate.
...
Weekly sample or monthly review

## Expected Output

Current SOP compared to actual work and proof
...
- Expected output: Current SOP compared to actual work and proof
