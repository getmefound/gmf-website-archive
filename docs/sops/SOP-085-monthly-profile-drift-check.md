# SOP 085 - Monthly profile drift check
...
Source of truth: `docs/sops/SOP-085-monthly-profile-drift-check.md`

## Purpose

Make the `Monthly profile drift check` workflow repeatable, auditable, and safe to delegate.
...
Drift report and fixes/blockers

## Roles

| Role | Responsibility |
|---|---|
| Owner | Profile Manager owns the outcome and keeps this SOP current |
...
- Expected output: Drift report and fixes/blockers
