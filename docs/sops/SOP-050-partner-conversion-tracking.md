# SOP 050 - Partner conversion tracking
...
Source of truth: `docs/sops/SOP-050-partner-conversion-tracking.md`

## Purpose

Make the `Partner conversion tracking` workflow repeatable, auditable, and safe to delegate.
...
Partner traffic or sale exists
...
- Expected output: UTM/ref attribution
