...
Status: Drafted
Version: 0.2
Owner: Profile Manager/Reporter
Reviewer: Auditor
Approver: Manager
Effective date: Set when Active
Next review: Set when Active
Source of truth: `docs/sops/SOP-065-google-ai-search-readiness-audit.md`

## Purpose

Make the `Google AI Search readiness audit` workflow repeatable, auditable, and safe to delegate.
...
Client baseline or Get Found work starts

## Expected Output

Crawlability, snippet eligibility, facts, content/proof, GBP, and Merchant Center notes

## Roles

| Role | Responsibility |
|---|---|
| Owner | Profile Manager/Reporter owns the outcome and keeps this SOP current |
...
1. Confirm the exact business profile, website, location/service area, and access level.
2. Check business facts, services/categories, website/profile consistency, review link, photos/media, and public visibility basics.
3. Identify proposed edits or recommendations and separate in-scope fixes from handoffs.
4. Do not edit public profile data unless access and approval are clear.
5. Save before/after proof, blockers, and next action.

## Required Proof

- Expected output: Crawlability, snippet eligibility, facts, content/proof, GBP, and Merchant Center notes
- Work record or Monday item
- Date/time, owner, and status
- Report/artifact link and source proof links
- Correct profile/business proof and before/after evidence when edits are made
