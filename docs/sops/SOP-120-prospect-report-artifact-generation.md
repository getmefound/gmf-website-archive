# SOP 120 - Prospect report artifact generation
...
Source of truth: `docs/sops/SOP-120-prospect-report-artifact-generation.md`

## Purpose

Make the `Prospect report artifact generation` workflow repeatable, auditable, and safe to delegate.
...
Prospect report requested

## Expected Output

Prospect-safe artifact
...
- Expected output: Prospect-safe artifact
