# SOP 072 - LocalBusiness schema recommendation
...
Source of truth: `docs/sops/SOP-072-localbusiness-schema-recommendation.md`

## Purpose

Make the `LocalBusiness schema recommendation` workflow repeatable, auditable, and safe to delegate.
...
Website needs structured data

## Expected Output

Schema plan or handoff
...
- Expected output: Schema plan or handoff
