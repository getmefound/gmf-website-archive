# SOP 048 - Declined partner email
...
Source of truth: `docs/sops/SOP-048-declined-partner-email.md`

## Purpose

Make the `Declined partner email` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Kind decline email
