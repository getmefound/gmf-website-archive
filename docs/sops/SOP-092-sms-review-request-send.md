# SOP 092 - SMS review request send
...
Source of truth: `docs/sops/SOP-092-sms-review-request-send.md`

## Purpose

Make the `SMS review request send` workflow repeatable, auditable, and safe to delegate.
...
SMS approved and compliant

## Expected Output

Send log and suppression proof
...
- Expected output: Send log and suppression proof
