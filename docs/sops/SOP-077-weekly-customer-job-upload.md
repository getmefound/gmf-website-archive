# SOP 077 - Weekly customer/job upload
...
Source of truth: `docs/sops/SOP-077-weekly-customer-job-upload.md`

## Purpose

Make the `Weekly customer/job upload` workflow repeatable, auditable, and safe to delegate.
...
Stay Found client needs review requests

## Expected Output

Upload/request reminder
...
- Expected output: Upload/request reminder
