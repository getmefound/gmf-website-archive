...
Source of truth: `docs/sops/SOP-133-supabase-backup-and-recovery.md`

## Purpose

Make the `Supabase backup and recovery` workflow repeatable, auditable, and safe to delegate.
...
Backup/PITR proof and recovery path
...
- Expected output: Backup/PITR proof and recovery path
