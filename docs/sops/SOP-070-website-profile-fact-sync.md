...
Source of truth: `docs/sops/SOP-070-website-profile-fact-sync.md`

## Purpose

Make the `Website/profile fact sync` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Fact sync checklist
