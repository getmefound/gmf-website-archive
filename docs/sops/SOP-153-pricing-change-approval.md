# SOP 153 - Pricing change approval
...
Source of truth: `docs/sops/SOP-153-pricing-change-approval.md`

## Purpose

Make the `Pricing change approval` workflow repeatable, auditable, and safe to delegate.
...
Approved price and site/docs update

## Roles

| Role | Responsibility |
|---|---|
| Owner | Sales Manager/Mike owns the outcome and keeps this SOP current |
...
- Expected output: Approved price and site/docs update
