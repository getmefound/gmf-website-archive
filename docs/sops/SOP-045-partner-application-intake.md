...
Source of truth: `docs/sops/SOP-045-partner-application-intake.md`

## Purpose

Make the `Partner application intake` workflow repeatable, auditable, and safe to delegate.
...
`/api/partners` submission

## Expected Output

`agent_tasks` row and confirmation email
...
- Expected output: `agent_tasks` row and confirmation email
