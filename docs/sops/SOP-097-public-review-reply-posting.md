# SOP 097 - Public review reply posting

Status: Drafted
Version: 0.2
Owner: Profile Manager/Reply Writer
Reviewer: Auditor
Approver: Manager
Effective date: Set when Active
Next review: Set when Active
Source of truth: `docs/sops/SOP-097-public-review-reply-posting.md`

## Purpose

Make the `Public review reply posting` workflow repeatable, auditable, and safe to delegate.
...
| Role | Responsibility |
|---|---|
| Owner | Profile Manager/Reply Writer owns the outcome and keeps this SOP current |
...
- Expected output: Posted reply proof
