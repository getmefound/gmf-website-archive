# SOP 147 - Daily/weekly revenue reconciliation
...
Source of truth: `docs/sops/SOP-147-daily-weekly-revenue-reconciliation.md`

## Purpose

Make the `Daily/weekly revenue reconciliation` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Daily/weekly revenue reconciliation
...
- Expected output: Stripe/revenue status
