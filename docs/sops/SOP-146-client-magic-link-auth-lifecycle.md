# SOP 146 - Client magic-link auth lifecycle
...
Source of truth: `docs/sops/SOP-146-client-magic-link-auth-lifecycle.md`

## Purpose

Make the `Client magic-link auth lifecycle` workflow repeatable, auditable, and safe to delegate.
...
Client hub access changes

## Expected Output

Link issue/revoke/refresh process
...
- Expected output: Link issue/revoke/refresh process
