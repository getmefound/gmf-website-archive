...
Source of truth: `docs/sops/SOP-106-client-call-request.md`

## Purpose

Make the `Client call request` workflow repeatable, auditable, and safe to delegate.
...
Call requested status and Manager route
...
- Expected output: Call requested status and Manager route
