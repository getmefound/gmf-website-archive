...
Source of truth: `docs/sops/SOP-087-monthly-recap-audit.md`

## Purpose

Make the `Monthly recap audit` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Claim/proof pass
