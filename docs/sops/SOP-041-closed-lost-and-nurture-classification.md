# SOP 041 - Closed-lost and nurture classification
...
Source of truth: `docs/sops/SOP-041-closed-lost-and-nurture-classification.md`

## Purpose

Make the `Closed-lost and nurture classification` workflow repeatable, auditable, and safe to delegate.
...
Prospect declines, goes quiet, or no-fit

## Expected Output

Status and next allowed touch
...
- Expected output: Status and next allowed touch
