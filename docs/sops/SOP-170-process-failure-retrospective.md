# SOP 170 - Process failure retrospective
...
Source of truth: `docs/sops/SOP-170-process-failure-retrospective.md`

## Purpose

Make the `Process failure retrospective` workflow repeatable, auditable, and safe to delegate.
...
Incident, missed step, complaint, or failed handoff

## Expected Output

Root cause and SOP/tool/training update
...
- Expected output: Root cause and SOP/tool/training update
