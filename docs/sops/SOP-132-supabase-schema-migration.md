# SOP 132 - Supabase schema migration
...
Source of truth: `docs/sops/SOP-132-supabase-schema-migration.md`

## Purpose

Make the `Supabase schema migration` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Migration applied and verified
