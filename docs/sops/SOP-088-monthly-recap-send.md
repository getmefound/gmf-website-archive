...
Source of truth: `docs/sops/SOP-088-monthly-recap-send.md`

## Purpose

Make the `Monthly recap send` workflow repeatable, auditable, and safe to delegate.
...
Auditor approves recap

## Expected Output

Client email and hub update
...
- Expected output: Client email and hub update
