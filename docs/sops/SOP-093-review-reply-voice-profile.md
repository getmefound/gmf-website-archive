# SOP 093 - Review reply voice profile
...
Source of truth: `docs/sops/SOP-093-review-reply-voice-profile.md`

## Purpose

Make the `Review reply voice profile` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Review reply voice profile
...
| Role | Responsibility |
|---|---|
| Owner | Reply Writer owns the outcome and keeps this SOP current |
...
- Expected output: Client voice profile
