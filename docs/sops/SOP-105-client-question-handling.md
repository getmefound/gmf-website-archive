# SOP 105 - Client question handling
...
Source of truth: `docs/sops/SOP-105-client-question-handling.md`

## Purpose

Make the `Client question handling` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Answer, route, or blocker
