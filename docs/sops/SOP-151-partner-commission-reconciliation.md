# SOP 151 - Partner commission reconciliation
...
Source of truth: `docs/sops/SOP-151-partner-commission-reconciliation.md`

## Purpose

Make the `Partner commission reconciliation` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Partner payout list
