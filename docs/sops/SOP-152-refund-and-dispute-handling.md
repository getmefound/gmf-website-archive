# SOP 152 - Refund and dispute handling
...
Source of truth: `docs/sops/SOP-152-refund-and-dispute-handling.md`

## Purpose

Make the `Refund and dispute handling` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Decision, action, and proof
