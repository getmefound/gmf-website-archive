...
Source of truth: `docs/sops/SOP-039-objection-handling.md`

## Purpose

Make the `Objection handling` workflow repeatable, auditable, and safe to delegate.
...
Prospect objects or hesitates

## Expected Output

Approved response by objection type
...
- Expected output: Approved response by objection type
