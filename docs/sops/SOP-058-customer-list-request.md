...
Source of truth: `docs/sops/SOP-058-customer-list-request.md`

## Purpose

Make the `Customer list request` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Customer upload ask
