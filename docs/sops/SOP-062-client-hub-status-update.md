...
Source of truth: `docs/sops/SOP-062-client-hub-status-update.md`

## Purpose

Make the `Client hub status update` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Client-safe hub status
