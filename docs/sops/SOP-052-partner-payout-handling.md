# SOP 052 - Partner payout handling
...
Source of truth: `docs/sops/SOP-052-partner-payout-handling.md`

## Purpose

Make the `Partner payout handling` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Partner payout handling
...
PayPal/bank payout proof

## Roles

| Role | Responsibility |
|---|---|
| Owner | Mike/Sales Manager owns the outcome and keeps this SOP current |
...
- Expected output: PayPal/bank payout proof
