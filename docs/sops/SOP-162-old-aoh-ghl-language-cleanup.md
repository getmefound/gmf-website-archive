# SOP 162 - Old AOH/GHL language cleanup
...
Source of truth: `docs/sops/SOP-162-old-aoh-ghl-language-cleanup.md`

## Purpose

Make the `Old AOH/GHL language cleanup` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Old AOH/GHL language cleanup
...
- Never enable HighLevel AI features without explicit Mike authorization for the exact feature and account.
...
- Expected output: GMF-safe language
