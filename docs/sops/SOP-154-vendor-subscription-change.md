# SOP 154 - Vendor subscription change
...
Source of truth: `docs/sops/SOP-154-vendor-subscription-change.md`

## Purpose

Make the `Vendor subscription change` workflow repeatable, auditable, and safe to delegate.
...
Upgrade/downgrade/cancel tool

## Expected Output

Spend decision and rollback risk

## Roles

| Role | Responsibility |
|---|---|
| Owner | Systems Director/Mike owns the outcome and keeps this SOP current |
...
- Expected output: Spend decision and rollback risk
