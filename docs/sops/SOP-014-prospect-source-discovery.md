# SOP 014 - Prospect source discovery
...
Source of truth: `docs/sops/SOP-014-prospect-source-discovery.md`

## Purpose

Make the `Prospect source discovery` workflow repeatable, auditable, and safe to delegate.
...
Need new prospect batch

## Expected Output

Source list with business name, website, location, and fit notes
...
- Expected output: Source list with business name, website, location, and fit notes
