# SOP 034 - Abandoned checkout detection
...
Source of truth: `docs/sops/SOP-034-abandoned-checkout-detection.md`

## Purpose

Make the `Abandoned checkout detection` workflow repeatable, auditable, and safe to delegate.
...
Stripe checkout started but payment not completed

## Expected Output

Recoverable checkout event or no-action reason
...
- Expected output: Recoverable checkout event or no-action reason
