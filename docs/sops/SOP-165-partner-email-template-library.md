# SOP 165 - Partner email template library
...
Source of truth: `docs/sops/SOP-165-partner-email-template-library.md`

## Purpose

Make the `Partner email template library` workflow repeatable, auditable, and safe to delegate.
...
Partner workflow changes

## Expected Output

Approved partner templates
...
- Expected output: Approved partner templates
