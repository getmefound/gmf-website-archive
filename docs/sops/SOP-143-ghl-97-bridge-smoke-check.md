# SOP 143 - GHL $97 bridge smoke check
...
Source of truth: `docs/sops/SOP-143-ghl-97-bridge-smoke-check.md`

## Purpose

Make the `GHL $97 bridge smoke check` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- GHL $97 bridge smoke check
...
Post-downgrade or monthly

## Expected Output

Bridge pass/watch/blocker report
...
- Expected output: Bridge pass/watch/blocker report
