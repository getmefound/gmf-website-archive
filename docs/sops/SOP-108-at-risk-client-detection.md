# SOP 108 - At-risk client detection
...
Source of truth: `docs/sops/SOP-108-at-risk-client-detection.md`

## Purpose

Make the `At-risk client detection` workflow repeatable, auditable, and safe to delegate.
...
Low activity, complaint, cancellation hint

## Expected Output

At-risk status and retention action
...
- Expected output: At-risk status and retention action
