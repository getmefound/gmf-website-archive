# SOP 142 - HighLevel AI feature safety check
...
Source of truth: `docs/sops/SOP-142-highlevel-ai-feature-safety-check.md`

## Purpose

Make the `HighLevel AI feature safety check` workflow repeatable, auditable, and safe to delegate.
...
GHL access, downgrade, or audit

## Expected Output

AI toggles confirmed off
...
- Expected output: AI toggles confirmed off
