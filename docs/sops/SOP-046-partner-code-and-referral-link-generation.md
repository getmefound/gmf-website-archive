# SOP 046 - Partner code and referral link generation
...
Source of truth: `docs/sops/SOP-046-partner-code-and-referral-link-generation.md`

## Purpose

Make the `Partner code and referral link generation` workflow repeatable, auditable, and safe to delegate.
...
Partner code and `/ref/code` link
...
- Expected output: Partner code and `/ref/code` link
