...
Source of truth: `docs/sops/SOP-060-client-baseline-visibility-report.md`

## Purpose

Make the `Client baseline visibility report` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Client baseline report
