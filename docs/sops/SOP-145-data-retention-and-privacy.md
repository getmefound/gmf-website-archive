# SOP 145 - Data retention and privacy
...
Source of truth: `docs/sops/SOP-145-data-retention-and-privacy.md`

## Purpose

Make the `Data retention and privacy` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Retention/deletion rules
