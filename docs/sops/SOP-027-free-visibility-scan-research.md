# SOP 027 - Free visibility scan research
...
Source of truth: `docs/sops/SOP-027-free-visibility-scan-research.md`

## Purpose

Make the `Free visibility scan research` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Public scan notes
