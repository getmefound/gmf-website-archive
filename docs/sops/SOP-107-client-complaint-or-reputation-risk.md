# SOP 107 - Client complaint or reputation risk
...
Source of truth: `docs/sops/SOP-107-client-complaint-or-reputation-risk.md`

## Purpose

Make the `Client complaint or reputation risk` workflow repeatable, auditable, and safe to delegate.
...
Client is upset or risk appears
...
- Expected output: Escalation and response plan
