# SOP 086 - Search Console and AI visibility signal review
...
Source of truth: `docs/sops/SOP-086-search-console-and-ai-visibility-signal-review.md`

## Purpose

Make the `Search Console and AI visibility signal review` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Search Console and AI visibility signal review
...
Query, page, click, impression, and AI/local observation notes

## Roles

| Role | Responsibility |
|---|---|
| Owner | Reporter owns the outcome and keeps this SOP current |
...
- Expected output: Query, page, click, impression, and AI/local observation notes
