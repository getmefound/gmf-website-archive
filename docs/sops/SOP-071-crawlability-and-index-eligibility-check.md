...
Source of truth: `docs/sops/SOP-071-crawlability-and-index-eligibility-check.md`

## Purpose

Make the `Crawlability and index eligibility check` workflow repeatable, auditable, and safe to delegate.
...
Website visibility work begins

## Expected Output

Indexable page, snippet, robots, sitemap, and Search Console notes

## Roles

| Role | Responsibility |
|---|---|
| Owner | Systems Director/Profile Manager owns the outcome and keeps this SOP current |
...
- Expected output: Indexable page, snippet, robots, sitemap, and Search Console notes
