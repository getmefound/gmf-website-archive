# SOP 053 - Stripe payment to client record
...
Source of truth: `docs/sops/SOP-053-stripe-payment-to-client-record.md`

## Purpose

Make the `Stripe payment to client record` workflow repeatable, auditable, and safe to delegate.
...
Client record and onboarding task
...
- Expected output: Client record and onboarding task
