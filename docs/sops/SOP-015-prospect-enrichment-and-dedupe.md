# SOP 015 - Prospect enrichment and dedupe
...
Source of truth: `docs/sops/SOP-015-prospect-enrichment-and-dedupe.md`

## Purpose

Make the `Prospect enrichment and dedupe` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Prospect enrichment and dedupe
...
- Expected output: Cleaned prospect rows
