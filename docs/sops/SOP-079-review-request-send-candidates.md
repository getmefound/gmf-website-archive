# SOP 079 - Review request send candidates
...
Source of truth: `docs/sops/SOP-079-review-request-send-candidates.md`

## Purpose

Make the `Review request send candidates` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Eligible send list
