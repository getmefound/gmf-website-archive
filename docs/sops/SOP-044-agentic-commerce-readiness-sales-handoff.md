# SOP 044 - Agentic commerce readiness sales handoff
...
Source of truth: `docs/sops/SOP-044-agentic-commerce-readiness-sales-handoff.md`

## Purpose

Make the `Agentic commerce readiness sales handoff` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Agentic commerce readiness sales handoff
...
Prospect asks about Google UCP, AI shopping, direct checkout, or Merchant Center

## Expected Output

Scope as research/advisory unless Mike approves implementation

## Roles

| Role | Responsibility |
|---|---|
| Owner | Sales Manager owns the outcome and keeps this SOP current |
...
1. Confirm the business question: fit, offer lane, price/scope, partner decision, campaign angle, objection, or upgrade path.
...
- Expected output: Scope as research/advisory unless Mike approves implementation
