# SOP 111 - Upgrade opportunity detection
...
Source of truth: `docs/sops/SOP-111-upgrade-opportunity-detection.md`

## Purpose

Make the `Upgrade opportunity detection` workflow repeatable, auditable, and safe to delegate.
