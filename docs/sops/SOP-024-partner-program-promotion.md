# SOP 024 - Partner program promotion
...
Source of truth: `docs/sops/SOP-024-partner-program-promotion.md`

## Purpose

Make the `Partner program promotion` workflow repeatable, auditable, and safe to delegate.
...
Need partner applicants

## Expected Output

Partner acquisition plan and approved copy
...
- Expected output: Partner acquisition plan and approved copy
