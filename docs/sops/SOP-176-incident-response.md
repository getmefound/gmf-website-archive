...
Source of truth: `docs/sops/SOP-176-incident-response.md`

## Purpose

Make the `Incident response` workflow repeatable, auditable, and safe to delegate.
...
Outage, broken send, exposed data, billing risk

## Expected Output

Incident log and recovery steps

## Roles

| Role | Responsibility |
|---|---|
| Owner | Systems Director/Auditor owns the outcome and keeps this SOP current |
...
- Expected output: Incident log and recovery steps
