# SOP 023 - Social reach prospecting
...
Source of truth: `docs/sops/SOP-023-social-reach-prospecting.md`

## Purpose

Make the `Social reach prospecting` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Social reach prospecting
...
Useful social thread, post, or comment appears

## Expected Output

Help-first action and trust signal log
...
- Expected output: Help-first action and trust signal log
