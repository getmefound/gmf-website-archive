...
Source of truth: `docs/sops/SOP-067-hours-phone-website-and-description-review.md`

## Purpose

Make the `Hours, phone, website, and description review` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Business fact sync notes
