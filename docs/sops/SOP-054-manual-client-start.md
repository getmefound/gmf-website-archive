...
Source of truth: `docs/sops/SOP-054-manual-client-start.md`

## Purpose

Make the `Manual client start` workflow repeatable, auditable, and safe to delegate.
...
Mike approves manual start

## Expected Output

Client record without normal checkout
...
- Expected output: Client record without normal checkout
