# SOP 163 - Objection and sales script library
...
Source of truth: `docs/sops/SOP-163-objection-and-sales-script-library.md`

## Purpose

Make the `Objection and sales script library` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Objection and sales script library
...
- Expected output: Approved scripts
