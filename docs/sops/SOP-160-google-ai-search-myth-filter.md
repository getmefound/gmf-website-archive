# SOP 160 - Google AI Search myth filter
...
Source of truth: `docs/sops/SOP-160-google-ai-search-myth-filter.md`

## Purpose

Make the `Google AI Search myth filter` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Google AI Search myth filter
...
New AI SEO/AEO/GEO tactic is proposed

## Expected Output

Approve, reject, or watch based on official guidance and client risk

## Roles

| Role | Responsibility |
|---|---|
| Owner | Coach/Auditor owns the outcome and keeps this SOP current |
...
- Expected output: Approve, reject, or watch based on official guidance and client risk
