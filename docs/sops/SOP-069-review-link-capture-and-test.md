...
Source of truth: `docs/sops/SOP-069-review-link-capture-and-test.md`

## Purpose

Make the `Review link capture and test` workflow repeatable, auditable, and safe to delegate.
...
Correct GBP confirmed

## Expected Output

Tested Google review link
...
- Expected output: Tested Google review link
