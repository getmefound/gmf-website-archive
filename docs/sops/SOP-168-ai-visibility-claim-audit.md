# SOP 168 - AI visibility claim audit
...
Source of truth: `docs/sops/SOP-168-ai-visibility-claim-audit.md`

## Purpose

Make the `AI visibility claim audit` workflow repeatable, auditable, and safe to delegate.
...
Report, sales copy, or client email mentions AI Search, AI Mode, or AI Overviews

## Expected Output

No ranking guarantees, no unsupported hacks, proof-backed wording
...
- Expected output: No ranking guarantees, no unsupported hacks, proof-backed wording
