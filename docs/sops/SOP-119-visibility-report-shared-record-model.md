# SOP 119 - Visibility report shared record model
...
Source of truth: `docs/sops/SOP-119-visibility-report-shared-record-model.md`

## Purpose

Make the `Visibility report shared record model` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Supabase report/event records
