# SOP 155 - Legal/privacy copy update
...
Source of truth: `docs/sops/SOP-155-legal-privacy-copy-update.md`

## Purpose

Make the `Legal/privacy copy update` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Legal/privacy copy update
...
Offer/data flow changes

## Expected Output

Updated terms/privacy copy request

## Roles

| Role | Responsibility |
|---|---|
| Owner | Coach owns the outcome and keeps this SOP current |
...
1. Confirm the trigger, owner, record, and expected output.
2. Gather the current source facts and check whether the work is safe to perform.
3. Complete the approved workflow inside scope.
4. Capture required proof and update the system of record.
5. Route blockers, risks, or next actions to the correct owner.

## Required Proof

- Expected output: Updated terms/privacy copy request
