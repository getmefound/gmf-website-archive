# SOP 082 - Private feedback routing
...
Source of truth: `docs/sops/SOP-082-private-feedback-routing.md`

## Purpose

Make the `Private feedback routing` workflow repeatable, auditable, and safe to delegate.
...
Customer leaves low/private feedback

## Expected Output

Feedback routed privately
...
- Expected output: Feedback routed privately
