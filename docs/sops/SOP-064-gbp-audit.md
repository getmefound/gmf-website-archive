...
Source of truth: `docs/sops/SOP-064-gbp-audit.md`

## Purpose

Make the `GBP audit` workflow repeatable, auditable, and safe to delegate.
...
Access confirmed or public scan allowed

## Expected Output

Profile gaps and recommended fixes
...
- Expected output: Profile gaps and recommended fixes
