# SOP 141 - Manager eval update loop
...
Source of truth: `docs/sops/SOP-141-manager-eval-update-loop.md`

## Purpose

Make the `Manager eval update loop` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Manager eval update loop
...
- Expected output: Scenario and passing eval
