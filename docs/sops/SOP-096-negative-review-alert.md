...
Source of truth: `docs/sops/SOP-096-negative-review-alert.md`

## Purpose

Make the `Negative review alert` workflow repeatable, auditable, and safe to delegate.
...
1-4 star or risky review appears

## Expected Output

Risk packet and recommended response
...
- Expected output: Risk packet and recommended response
