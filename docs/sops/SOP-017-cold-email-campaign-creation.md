# SOP 017 - Cold email campaign creation
...
Source of truth: `docs/sops/SOP-017-cold-email-campaign-creation.md`

## Purpose

Make the `Cold email campaign creation` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Cold email campaign creation
...
Approved outreach theme

## Expected Output

Campaign draft, sequence, audience, and risk notes
...
- Expected output: Campaign draft, sequence, audience, and risk notes
