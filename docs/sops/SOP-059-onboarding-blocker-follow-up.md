# SOP 059 - Onboarding blocker follow-up
...
Source of truth: `docs/sops/SOP-059-onboarding-blocker-follow-up.md`

## Purpose

Make the `Onboarding blocker follow-up` workflow repeatable, auditable, and safe to delegate.
...
Reminder every two business days
...
- Expected output: Reminder every two business days
