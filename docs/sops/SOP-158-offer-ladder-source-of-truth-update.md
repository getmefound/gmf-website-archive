# SOP 158 - Offer ladder source-of-truth update
...
Source of truth: `docs/sops/SOP-158-offer-ladder-source-of-truth-update.md`

## Purpose

Make the `Offer ladder source-of-truth update` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Docs/site copy alignment
