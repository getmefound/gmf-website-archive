...
Source of truth: `docs/sops/SOP-109-cancellation-request.md`

## Purpose

Make the `Cancellation request` workflow repeatable, auditable, and safe to delegate.
...
Cancel path, final service state, Mike flags
...
- Expected output: Cancel path, final service state, Mike flags
