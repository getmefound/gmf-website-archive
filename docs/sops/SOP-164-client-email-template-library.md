# SOP 164 - Client email template library

Status: Drafted
Version: 0.2
Owner: Account Manager/Coach
Reviewer: Coach/Auditor
Approver: SOP owner
Effective date: Set when Active
Next review: Set when Active
Source of truth: `docs/sops/SOP-164-client-email-template-library.md`

## Purpose

Make the `Client email template library` workflow repeatable, auditable, and safe to delegate.
...
| Role | Responsibility |
|---|---|
| Owner | Account Manager/Coach owns the outcome and keeps this SOP current |
...
- Expected output: Approved templates
