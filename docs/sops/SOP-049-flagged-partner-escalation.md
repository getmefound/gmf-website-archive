# SOP 049 - Flagged partner escalation
...
Source of truth: `docs/sops/SOP-049-flagged-partner-escalation.md`

## Purpose

Make the `Flagged partner escalation` workflow repeatable, auditable, and safe to delegate.
...
Applicant needs Mike decision

## Expected Output

Slack/Mike packet and no applicant email yet
...
- Expected output: Slack/Mike packet and no applicant email yet
