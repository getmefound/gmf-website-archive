...
Source of truth: `docs/sops/SOP-095-review-reply-approval.md`

## Purpose

Make the `Review reply approval` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Approve/reject/post decision
