# SOP 115 - Timed upgrade email template library

Status: Drafted
Version: 0.2
Owner: Sales Manager/Coach
Reviewer: Coach/Auditor
Approver: SOP owner
Effective date: Set when Active
Next review: Set when Active
Source of truth: `docs/sops/SOP-115-timed-upgrade-email-template-library.md`

## Purpose

Make the `Timed upgrade email template library` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Timed upgrade email template library
...
Cadence slot or evidence trigger exists

## Expected Output

Approved email by plan, proof signal, and tone

## Roles

| Role | Responsibility |
|---|---|
| Owner | Sales Manager/Coach owns the outcome and keeps this SOP current |
...
- Expected output: Approved email by plan, proof signal, and tone
