# SOP 090 - Always Ready onboarding
...
Source of truth: `docs/sops/SOP-090-always-ready-onboarding.md`

## Purpose

Make the `Always Ready onboarding` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Always Ready onboarding
...
Client buys/upgrades

## Expected Output

Expanded onboarding checklist
...
- Expected output: Expanded onboarding checklist
