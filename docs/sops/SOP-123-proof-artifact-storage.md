# SOP 123 - Proof artifact storage
...
Source of truth: `docs/sops/SOP-123-proof-artifact-storage.md`

## Purpose

Make the `Proof artifact storage` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Proof link/file
