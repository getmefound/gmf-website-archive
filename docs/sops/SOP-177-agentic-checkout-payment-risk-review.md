# SOP 177 - Agentic checkout/payment risk review

Status: Drafted
Version: 0.2
Owner: Auditor/Systems Director
Reviewer: Manager
Approver: Manager; Mike when material business risk applies
Effective date: Set when Active
Next review: Set when Active
Source of truth: `docs/sops/SOP-177-agentic-checkout-payment-risk-review.md`

## Purpose

Make the `Agentic checkout/payment risk review` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Agentic checkout/payment risk review
...
Any UCP/AP2/direct-checkout implementation is proposed

## Expected Output

Payment, privacy, merchant-of-record, refund, and support risk decision

## Roles

| Role | Responsibility |
|---|---|
| Owner | Auditor/Systems Director owns the outcome and keeps this SOP current |
...
- Expected output: Payment, privacy, merchant-of-record, refund, and support risk decision
