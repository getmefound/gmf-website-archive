...
Source of truth: `docs/sops/SOP-131-vercel-deploy-and-rollback.md`

## Purpose

Make the `Vercel deploy and rollback` workflow repeatable, auditable, and safe to delegate.
...
Deploy proof and rollback path
...
- Expected output: Deploy proof and rollback path
