...
Source of truth: `docs/sops/SOP-083-review-monitoring.md`

## Purpose

Make the `Review monitoring` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: New review count and notes
