...
Source of truth: `docs/sops/SOP-055-magic-link-client-access.md`

## Purpose

Make the `Magic-link client access` workflow repeatable, auditable, and safe to delegate.
...
Client access without password account
...
- Expected output: Client access without password account
