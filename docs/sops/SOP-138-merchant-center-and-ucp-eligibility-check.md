# SOP 138 - Merchant Center and UCP eligibility check
...
Source of truth: `docs/sops/SOP-138-merchant-center-and-ucp-eligibility-check.md`

## Purpose

Make the `Merchant Center and UCP eligibility check` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Merchant Center and UCP eligibility check
...
Client sells eligible products, bookings, or delivery services

## Expected Output

Eligibility/readiness checklist, not implementation promise
...
- Expected output: Eligibility/readiness checklist, not implementation promise
