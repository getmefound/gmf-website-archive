# SOP 073 - Helpful proof content recommendation

Status: Drafted
Version: 0.2
Owner: Profile Manager/Coach
Reviewer: Coach/Auditor
Approver: SOP owner
Effective date: Set when Active
Next review: Set when Active
Source of truth: `docs/sops/SOP-073-helpful-proof-content-recommendation.md`

## Purpose

Make the `Helpful proof content recommendation` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Helpful proof content recommendation
...
Generic or commodity site content found

## Expected Output

Specific client proof, story, photo, video, or FAQ recommendation

## Roles

| Role | Responsibility |
|---|---|
| Owner | Profile Manager/Coach owns the outcome and keeps this SOP current |
...
- Expected output: Specific client proof, story, photo, video, or FAQ recommendation
