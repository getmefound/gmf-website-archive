# SOP 159 - Research ingestion from Scout
...
Source of truth: `docs/sops/SOP-159-research-ingestion-from-scout.md`

## Purpose

Make the `Research ingestion from Scout` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Research ingestion from Scout
...
Search/Google/platform change found

## Expected Output

Plain-English agent instruction
...
- Expected output: Plain-English agent instruction
