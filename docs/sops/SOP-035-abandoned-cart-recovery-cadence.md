# SOP 035 - Abandoned cart recovery cadence
...
Source of truth: `docs/sops/SOP-035-abandoned-cart-recovery-cadence.md`

## Purpose

Make the `Abandoned cart recovery cadence` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Abandoned cart recovery cadence
...
Checkout abandoned with usable contact info

## Expected Output

1-hour/24-hour/72-hour recovery decision
...
- Expected output: 1-hour/24-hour/72-hour recovery decision
