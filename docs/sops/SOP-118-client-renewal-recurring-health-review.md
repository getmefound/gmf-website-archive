# SOP 118 - Client renewal/recurring health review
...
Source of truth: `docs/sops/SOP-118-client-renewal-recurring-health-review.md`

## Purpose

Make the `Client renewal/recurring health review` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Client renewal/recurring health review
...
- Expected output: Retention health summary
