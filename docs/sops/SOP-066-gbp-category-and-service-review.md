...
Source of truth: `docs/sops/SOP-066-gbp-category-and-service-review.md`

## Purpose

Make the `GBP category and service review` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Category/service update plan
