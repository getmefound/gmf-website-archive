# SOP 043 - Upgrade sale from existing client
...
Source of truth: `docs/sops/SOP-043-upgrade-sale-from-existing-client.md`

## Purpose

Make the `Upgrade sale from existing client` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Upgrade sale from existing client
...
Upgrade angle and Sales Rep email
...
- Expected output: Upgrade angle and Sales Rep email
