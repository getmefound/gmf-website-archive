# SOP 029 - Prospect report claim audit
...
Source of truth: `docs/sops/SOP-029-prospect-report-claim-audit.md`

## Purpose

Make the `Prospect report claim audit` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Pass/fail with edits
