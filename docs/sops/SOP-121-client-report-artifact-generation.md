# SOP 121 - Client report artifact generation
...
Source of truth: `docs/sops/SOP-121-client-report-artifact-generation.md`

## Purpose

Make the `Client report artifact generation` workflow repeatable, auditable, and safe to delegate.
...
Client baseline or monthly report needed
...
- Expected output: Client proof artifact
