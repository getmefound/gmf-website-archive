...
Source of truth: `docs/sops/SOP-056-welcome-email.md`

## Purpose

Make the `Welcome email` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Welcome email and next ask
