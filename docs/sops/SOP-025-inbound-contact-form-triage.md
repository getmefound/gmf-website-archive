# SOP 025 - Inbound contact form triage
...
Source of truth: `docs/sops/SOP-025-inbound-contact-form-triage.md`

## Purpose

Make the `Inbound contact form triage` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Inbound contact form triage
...
Sales/client/support route and reply draft
...
- Expected output: Sales/client/support route and reply draft
