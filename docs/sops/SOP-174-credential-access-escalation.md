...
Source of truth: `docs/sops/SOP-174-credential-access-escalation.md`

## Purpose

Make the `Credential/access escalation` workflow repeatable, auditable, and safe to delegate.
...
| Role | Responsibility |
|---|---|
| Owner | Systems Director/Manager owns the outcome and keeps this SOP current |
...
- Expected output: Mike-only request
