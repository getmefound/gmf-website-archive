...
Source of truth: `docs/sops/SOP-134-resend-domain-and-email-health.md`

## Purpose

Make the `Resend domain and email health` workflow repeatable, auditable, and safe to delegate.
...
Email send path used

## Expected Output

Domain/auth/delivery proof
...
- Expected output: Domain/auth/delivery proof
