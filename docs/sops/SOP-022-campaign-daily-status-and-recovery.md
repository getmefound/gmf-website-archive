# SOP 022 - Campaign daily status and recovery
...
Source of truth: `docs/sops/SOP-022-campaign-daily-status-and-recovery.md`

## Purpose

Make the `Campaign daily status and recovery` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Campaign daily status and recovery
...
Scheduled campaign day

## Expected Output

Sent/not sent status and blocker summary
...
- Expected output: Sent/not sent status and blocker summary
