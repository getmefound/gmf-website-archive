# SOP 076 - Get Found delivery email
...
Source of truth: `docs/sops/SOP-076-get-found-delivery-email.md`

## Purpose

Make the `Get Found delivery email` workflow repeatable, auditable, and safe to delegate.
...
Auditor approves completion

## Expected Output

Client-safe summary and next action
...
- Expected output: Client-safe summary and next action
