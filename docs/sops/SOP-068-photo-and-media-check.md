...
Source of truth: `docs/sops/SOP-068-photo-and-media-check.md`

## Purpose

Make the `Photo and media check` workflow repeatable, auditable, and safe to delegate.
...
- Expected output: Photo/media recommendation
