# SOP 098 - AI/local answer visibility check
...
Source of truth: `docs/sops/SOP-098-ai-local-answer-visibility-check.md`

## Purpose

Make the `AI/local answer visibility check` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- AI/local answer visibility check
...
Deeper visibility observations
...
- Expected output: Deeper visibility observations
