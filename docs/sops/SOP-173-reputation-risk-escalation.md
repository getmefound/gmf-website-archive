# SOP 173 - Reputation risk escalation
...
Source of truth: `docs/sops/SOP-173-reputation-risk-escalation.md`

## Purpose

Make the `Reputation risk escalation` workflow repeatable, auditable, and safe to delegate.
...
Bad review, complaint, legal/safety issue

## Expected Output

Mike escalation packet

## Roles

| Role | Responsibility |
|---|---|
| Owner | Auditor/Manager owns the outcome and keeps this SOP current |
...
- Expected output: Mike escalation packet
