# SOP 063 - Onboarding done criteria
...
Source of truth: `docs/sops/SOP-063-onboarding-done-criteria.md`

## Purpose

Make the `Onboarding done criteria` workflow repeatable, auditable, and safe to delegate.
...
Launch work appears complete

## Expected Output

Proof gate pass/fail
...
- Expected output: Proof gate pass/fail
