# SOP 122 - Report download/archive
...
Source of truth: `docs/sops/SOP-122-report-download-archive.md`

## Purpose

Make the `Report download/archive` workflow repeatable, auditable, and safe to delegate.
...
Downloadable report and storage link
...
- Expected output: Downloadable report and storage link
