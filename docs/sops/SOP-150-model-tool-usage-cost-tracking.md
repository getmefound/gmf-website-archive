# SOP 150 - Model/tool usage cost tracking
...
Source of truth: `docs/sops/SOP-150-model-tool-usage-cost-tracking.md`

## Purpose

Make the `Model/tool usage cost tracking` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Model/tool usage cost tracking
...
- Expected output: Cost per client/service
