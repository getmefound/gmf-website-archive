# SOP 051 - Monthly partner commission reconciliation
...
Source of truth: `docs/sops/SOP-051-monthly-partner-commission-reconciliation.md`

## Purpose

Make the `Monthly partner commission reconciliation` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Monthly partner commission reconciliation
...
Stripe/GA4 review and payout list
...
- Expected output: Stripe/GA4 review and payout list
