...
Source of truth: `docs/sops/SOP-128-sop-health-dashboard.md`

## Purpose

Make the `SOP health dashboard` workflow repeatable, auditable, and safe to delegate.
...
SOP counts by status, priority, owner, stale review, and blocked P0

## Roles

| Role | Responsibility |
|---|---|
| Owner | Manager/Coach owns the outcome and keeps this SOP current |
...
- Expected output: SOP counts by status, priority, owner, stale review, and blocked P0
