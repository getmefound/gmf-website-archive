# SOP 036 - Abandoned cart email templates
...
Source of truth: `docs/sops/SOP-036-abandoned-cart-email-templates.md`

## Purpose

Make the `Abandoned cart email templates` workflow repeatable, auditable, and safe to delegate.
...
Approved helper emails by offer
...
- Expected output: Approved helper emails by offer
