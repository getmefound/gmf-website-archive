# SOP 104 - Strategy call follow-up
...
Source of truth: `docs/sops/SOP-104-strategy-call-follow-up.md`

## Purpose

Make the `Strategy call follow-up` workflow repeatable, auditable, and safe to delegate.
...
Summary, decisions, next actions
...
- Expected output: Summary, decisions, next actions
