# SOP 140 - Slack Manager command routing
...
Source of truth: `docs/sops/SOP-140-slack-manager-command-routing.md`

## Purpose

Make the `Slack Manager command routing` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Slack Manager command routing
...
Slack command or bot change

## Expected Output

Command behavior and eval proof

## Roles

| Role | Responsibility |
|---|---|
| Owner | Manager/Systems Director owns the outcome and keeps this SOP current |
...
- Expected output: Command behavior and eval proof
