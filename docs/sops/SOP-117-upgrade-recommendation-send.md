# SOP 117 - Upgrade recommendation send
...
Source of truth: `docs/sops/SOP-117-upgrade-recommendation-send.md`

## Purpose

Make the `Upgrade recommendation send` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Upgrade recommendation send
...
Sales Manager approves angle

## Expected Output

Upgrade email/call path
...
- Expected output: Upgrade email/call path
