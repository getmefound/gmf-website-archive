# SOP 124 - Mission Control owner summary
...
Source of truth: `docs/sops/SOP-124-mission-control-owner-summary.md`

## Purpose

Make the `Mission Control owner summary` workflow repeatable, auditable, and safe to delegate.

## Covered Master Map Rows

- Mission Control owner summary
...
- Expected output: Owner-visible status
