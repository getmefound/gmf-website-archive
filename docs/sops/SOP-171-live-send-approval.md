...
Source of truth: `docs/sops/SOP-171-live-send-approval.md`

## Purpose

Make the `Live send approval` workflow repeatable, auditable, and safe to delegate.
...
Email/SMS/campaign send requested

## Expected Output

Send approved or blocked
...
- Expected output: Send approved or blocked
