# SOP 127 - Monthly business review
...
Source of truth: `docs/sops/SOP-127-monthly-business-review.md`

## Purpose

Make the `Monthly business review` workflow repeatable, auditable, and safe to delegate.
...
Clients, revenue, risk, upgrades, blockers
...
- Expected output: Clients, revenue, risk, upgrades, blockers
